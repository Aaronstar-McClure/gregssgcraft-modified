...
BACKUP_INCLUDE ?= *
BACKUP_EXCLUDE ?= --exclude build --exclude jars --exclude lib --exclude Releases --exclude '*-Releases' \
	--exclude Test --exclude Ancillary --exclude game --exclude 'game-*' --exclude logs \
	--exclude '*.zip' --exclude '*.jar' $(BACKUP_EXCLUDE_EXTRA)
